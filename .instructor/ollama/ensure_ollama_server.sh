...
# start of the session — or, better, the evening before, so a busy GPU queue is a
...
# the local-LLM material is ~3 hours (docs/day2/index.md), so 4 gives an hour of slack for a late
