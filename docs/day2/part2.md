...
| [2. Scale the Loop to an Array]({{ '/day2/loop-to-array/' | relative_url }}) | Work out how a loop becomes an array, write both files yourself, run 100 filings | Combine the results into one CSV |
...
| [5. Bonus — GPUs & Local LLMs]({{ '/day2/gpus/' | relative_url }}) | Ask Slurm for a GPU, serve an open-weight model on it, and query it without your data leaving the Yens | *the whole page* |
