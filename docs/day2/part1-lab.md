...
nav_order: 1
permalink: /day2/part1-lab/
---

# Part 1 Lab

You cannot read a script's resource needs off the code — you have to measure them while it
runs. Six exercises: measure what your script costs, write the numbers down, then declare
them to the scheduler and hand the job over.

{: .important }
> **Six mandatory exercises, about 65 minutes.** Do them in order — each one's output is
> the next one's input, and the numbers you write down in exercise 3 are the `#SBATCH`
> lines you write in exercise 5.
>
> If you get through them with time left, the **Bonus** section at the end is deep enough
> to fill it. First check whether anyone at your table is stuck.
...
## 3. Write Down What You Measured
...
## 5. Write and Submit a Slurm Job
...
## Bonus
{: .note }
> **Done with all six?** First check whether anyone at your table is stuck — explaining it is how it sticks. Then pick anything below.
